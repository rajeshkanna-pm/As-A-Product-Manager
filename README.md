...
<details>
  ...
  ### Product Objective
  CREST serves as an all-in-one retail orchestration platform. It was designed to replace fragmented thirdparty   software with a single, mobile-first interface for store associates
  ...
  * Adoption:
    ...
    Checkout time had increased by 2.5x times than the traditional method
    Clienteling engagement: User engagement ratio has increased by 25%
    NPS, CSAT Scoring had improved
  * Growth
    DTC (Direct to Consumer) business growth has increased by $1.5M YoY
    Stock out recovery and Inventory optimization rate improved sustainability on every quarter  
